...
export default function MeditatePage() {
  ...
  return (
    <div className="max-w-4xl mx-auto px-5 py-6 lg:py-10">
      ...
      <Link
        href="/meditate/sleep"
        className="card bg-gradient-to-r from-indigo-50 to-purple-50 border-0 mb-6 group flex items-center gap-4"
      >
        <div className="w-14 h-14 rounded-2xl bg-indigo-100 flex items-center justify-center text-2xl flex-shrink-0 group-hover:scale-105 transition-transform">
          🌙
        </div>
        <div className="flex-1">
          ...
          <p className="text-xs text-gray-500 mt-0.5">
            Calming music, ambient sounds &amp; sleep timer with Scripture
          </p>
        </div>
